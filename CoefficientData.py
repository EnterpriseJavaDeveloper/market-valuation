...
@gen_repr
@gen_eq
class CoefficientData(dict, Base):
    ...
    def __init__(self, name, intercept, dividend_coef, earnings_coef, treasury_coef):
        self.name = name
        self.intercept = intercept
        self.dividend_coef = dividend_coef
        self.earnings_coef = earnings_coef
        self.treasury_coef = treasury_coef
        dict.__init__(self, name=name, intercept=intercept, dividend_coef=dividend_coef, earnings_coef=earnings_coef, treasury_coef=treasury_coef)
